# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-01 09:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signer_mobile', models.CharField(default='', max_length=11, verbose_name='点话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '咨询'), (4, '售后'), (5, '求购')], default=1, help_text='留言类型：1(留言),2(投诉),3(咨询),4(售后),5(求购)', verbose_name='留言类型')),
